...
const static float TESS_ALPHA_MAX = 1.0f;
const static float TESS_LEVEL_MAX = 1000.0f;
...
const char DEFSHADING_GEOM_PASS_TESC_SHADER[] = "shaders/geom_pass_tess_shader.tesc";
const char DEFSHADING_GEOM_PASS_TESE_SHADER[] = "shaders/geom_pass_tess_shader.tese";
const char DEFSHADING_LIGHT_PASS_VERTEX_SHADER[] = "shaders/light_pass_vertex_shader.vert";
...
const char POSITION_UNIFORM[] = "g_position_map";
...
const char PTLIGHT_COLOR_UNIFORM[] = "g_point_light.base.color";
const char PTLIGHT_AMBIENT_INTENSITY_UNIFORM[] = "g_point_light.base.ambient_intensity";
const char PTLIGHT_POSITION_UNIFORM[] = "g_point_light.position";
const char PTLIGHT_DIFFUSE_INTENSITY_UNIFORM[] = "g_point_light.base.diffuse_intensity";
const char PTLIGHT_ATTEN_CONST_UNIFORM[] = "g_point_light.attenuation.constant";
const char PTLIGHT_ATTEN_LINEAR_UNIFORM[] = "g_point_light.attenuation.linear";
const char PTLIGHT_ATTEN_EXP_UNIFORM[] = "g_point_light.attenuation.exponential";

const char SPOTLIGHT_COLOR_UNIFORM[] = "g_spot_light.base.base.color";
const char SPOTLIGHT_AMBIENT_INTENSITY_UNIFORM[] = "g_spot_light.base.base.ambient_intensity";
const char SPOTLIGHT_POSITION_UNIFORM[] = "g_spot_light.base.position";
const char SPOTLIGHT_DIFFUSE_INTENSITY_UNIFORM[] = "g_spot_light.base.base.diffuse_intensity";
const char SPOTLIGHT_ATTEN_CONST_UNIFORM[] = "g_spot_light.base.attenuation.constant";
const char SPOTLIGHT_ATTEN_LINEAR_UNIFORM[] = "g_spot_light.base.attenuation.linear";
const char SPOTLIGHT_ATTEN_EXP_UNIFORM[] = "g_spot_light.base.attenuation.exponential";
const char SPOTLIGHT_DIRECTION_UNIFORM[] = "g_spot_light.direction";
const char SPOTLIGHT_CONE_UNIFORM[] = "g_spot_light.cone_angle";
