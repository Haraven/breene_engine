...
flat out int instance_id_tese[3];
...
void main()
{
	wvp_tese[gl_InvocationID] = wvp_tesc[gl_InvocationID];
	instance_id_tese[gl_InvocationID] = instance_id_tesc[gl_InvocationID];
